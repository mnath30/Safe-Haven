...
export const ChatBubbleOvalLeftEllipsisIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 01-2.53-.388m-2.53-.388a2.25 2.25 0 00-1.121.442c-1.109.646-2.298-.077-2.298-1.521v-3.486c0-.823.58-1.528 1.35-1.744M21 12c0-4.556-4.03-8.25-9-8.25S3 7.444 3 12m18 0v.008c0 .263-.213.488-.478.488h-.008v-.016c0-.264.213-.487.478-.487h.008v.008z" />
  </svg>
);
